...
*/
     ...
     * 科学计数法转为String
     */
    public static String serviceToString(String objectString){
    	NumberFormat nf = NumberFormat.getInstance();
		String s = nf.format(objectString);
     ...
     * 在当前数字前补充足够的0以达到指定长度
     * @author 王鹏
     * @version 2018-05-14 09:40:29
     * @param num
     * @param length
     * @return
     */
    public static String patchZero(Integer num, Integer length) {
    	int patchNum = (num==null||num<0)?length:(length-String.valueOf(num).length());
