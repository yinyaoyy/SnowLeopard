...
//			this.baseURL = ServletContextFactory.getServletContext().getContextPath()+"/userfiles/"+principal+"/";
			this.baseURL = FileUtils.path(Global.USERFILES_BASE_URL + principal + "/");
//			this.baseDir = FileUtils.path(System.getProperty("catalina.home")+"/webapps"+ Global.USERFILES_BASE_URL + principal + "/");
