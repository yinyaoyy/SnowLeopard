...
public class ActUtils {
	...
	public static final String[] PD_GONGCHU = new String[]{"gongchu", "oa_gongchu"};
	 ...
	 * @return
	 */
	public static String getFormUrl(String formKey, Act act , String zt){
		...
		formUrl.append("&zt=").append(zt != "" && zt != null ? zt : "");
