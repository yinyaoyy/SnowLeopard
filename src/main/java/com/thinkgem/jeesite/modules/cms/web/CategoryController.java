...
public class CategoryController extends BaseController {
	...
	public String list(Model model) {
		...
		List<Category> sourcelist = categoryService.findByUserOld(true, null);
	...
	public String form(Category category, Model model) {
		...
		//System.out.println(parent.getAllowComment());
	...
	public List<Map<String, Object>> treeData(String modules, @RequestParam(required=false) String extId, HttpServletResponse response) {
		response.setContentType("application/json; charset=UTF-8");
		List<Map<String, Object>> mapList = Lists.newArrayList();
		List<Category> list = categoryService.findByUser(true, modules);
