...
(function (a) {
	a.jBox = function (b, c) {
		...
		var u = a.browser.msie ? 'line-height:19px;' : '';
		a.each(b, function (N, O) {
			...
			r.push('<div class="jbox-button-panel" style="padding:5px 0 5px 0;text-align: center;' + (P ? '' : 'display:none;') + '">');
			if (!c.isTip) {
	...
	a.jBox.prompt = function (b, c, d, e) {
		...
		var h = [];
		h.push('html:');
		h.push('<div style="margin:10px;' + g + 'text-align:center;">');
