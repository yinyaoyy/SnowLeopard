...
<input class="btn btn-primary" type="button" value="${selectMultiple?'添加':'选择'}" onclick="${input}FinderOpen();"/>&nbsp;&nbsp;&nbsp;
<input class="btn btn-primary" type="button" value="清除" onclick="${input}DelAll();"/>
</c:if>
<script type="text/javascript">
	...
	function ${input}Preview(){
		var val = $("#${input}").val();
		var li, urls = (typeof(val) == "undefined")?"":val.split("|");
