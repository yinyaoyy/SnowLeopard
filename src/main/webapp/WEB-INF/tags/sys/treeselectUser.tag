...
<script type="text/javascript">
	$("#${id}Button, #${id}Name").click(function(){
		...
		var caseTown = $("#caseTownId").val();
		var caseCounty = $("#caseCountyId").val();
		// 正常打开	
		top.$.jBox.open("iframe:${ctx}/tag/treeselect?url="+encodeURIComponent("${url}"+"&companyId="+companyId+"&module=${module}&checked=${checked}&extId=${extId}&isAll=${isAll}"+"&caseTown="+caseTown+"&caseCounty="+caseCounty), "选择${title}", 300, 420, {
