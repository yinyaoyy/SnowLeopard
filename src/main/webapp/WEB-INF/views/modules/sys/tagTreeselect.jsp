...
<head>
	...
	<script type="text/javascript">
		var key, lastValue = "", nodeList = [], type = getQueryString("type", "${url}"),
			checked = getQueryString("checked", "${url}");
		var tree, setting = {view:{selectedMulti:false,dblClickExpand:false},check:{enable:(checked=='true'?true:false),nocheckInherit:true},
