...
<link rel="icon" href="${ctxStatic}/images/platform/favicon.ico" type="image/x-icon">
<script type="text/javascript">var ctx = '${ctx}', ctxStatic='${ctxStatic}';var jsCtx="${ctx}";</script>
...
<script src="${ctxStatic}/snowLeopard/js/bootstrap.min.js" type="text/javascript"></script>
...
<script type="text/javascript" src="${ctxStatic}/toastr/toastr.min.js"></script>
<script type="text/javascript" src="${ctxStatic}/flavr/js/flavr.min.js"></script>