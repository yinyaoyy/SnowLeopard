...
<head>
	...
	<style type="text/css">
		body {font-family: "Helvetica Neue",Helvetica,Arial,"Microsoft Yahei","Hiragino Sans GB","Heiti SC","WenQuanYi Micro Hei",sans-serif;margin: 0;color: #222222;
		...
		<style type="text/css">
		.wz_header {/*position:relative;height:100%;*/color:#222;font-family:"Helvetica Neue",Helvetica,Arial,"Microsoft Yahei","Hiragino Sans GB","Heiti SC","WenQuanYi Micro Hei",sans-serif;/*background-color:#f0f0f0;*/margin:0;padding: 0;text-decoration: none;}
