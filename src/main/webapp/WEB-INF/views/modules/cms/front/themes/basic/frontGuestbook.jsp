...
<script src="${ctxStatic}/jquery-validate/jquery.validate.min.js" type="text/javascript"></script>
<%-- <script src="${ctxStatic}/jquery-validate/jquery.validate.method.min.js" type="text/javascript"></script> --%>
			...
			<div class="control-group">
				...
				<div class="controls">
					<select name="type" class="txt required" style="width:100px;">
						<option value="">${fns:getLanguageContent('sys_select_select')}</option>
