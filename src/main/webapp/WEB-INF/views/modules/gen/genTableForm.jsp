	     ...
	     $("#comments").focus();
		  $("#inputForm").validate({submitHandler : function(form) {
			...
			$("input[type=checkbox]").each(function() {
				...
				errorContainer : "#messageBox",errorPlacement : function(error,element) {
				...
				<div class="row">
					<div class="col-xs-3">
						<div class="form-group">
							...
							<form:select path="name" class="input-xxlarge form-control valid">
					...
					<div class="col-xs-3">
						<div class="form-group">
							<input id="btnSubmit" class="btn btn-primary" type="submit"
								value="下一步" />&nbsp; <input id="btnCancel" class="btn btn-primary"
						...
						<div class="col-xs-3">
							<div class="form-group">
								...
								<form:input path="name" htmlEscape="false" maxlength="200"
									class="form-control valid" readonly="true" />
							</div>
						</div>
					</div>
					<div class="row">
					...
					<div class="row">
						<div class="col-xs-3">
							<div class="form-group">
								...
								<form:select path="parentTable" cssClass="input-xlarge form-control valid">
						...
						<div class="col-xs-3">
							<div class="form-group">
								...
								<form:select path="parentTableFk" cssClass="input-xlarge form-control valid">
								<form:option value="">无</form:option>
								<form:options items="${genTable.columnList}"
									itemLabel="nameAndComments" itemValue="name" htmlEscape="false" />
							</form:select>
							<p class="help-inline addpage-prompt">如果有父表，请指定父表表名和外键</p>
							</div>
						</div>
					</div>
							...
							<tbody>
								<c:forEach items="${genTable.columnList}" var="column"
									...
									<tr
										...
										<td nowrap style="line-height: 30px;"><input type="hidden"
										...
										<td><select name="columnList[${vs.index}].javaType"
											class="required input-mini form-control" style="width: 85px; *width: 75px">
										...
										<td><input type="text"
											...
											class="required input-small form-control" /></td>
										...
										<td><select name="columnList[${vs.index}].queryType"
											class="required input-mini form-control">
										...
										<td><select name="columnList[${vs.index}].showType"
											class="required form-control" style="width: 100px;">
										...
										<td><input type="text"
											...
											value="${column.dictType}" maxlength="200" class="input-mini form-control" />
										</td>
										<td><input type="text"
