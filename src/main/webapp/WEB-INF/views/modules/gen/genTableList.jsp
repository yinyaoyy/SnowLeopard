	...
	<form:form id="searchForm" modelAttribute="genTable"
		...
		<div class="form-group" style="margin-left: -10px;">
			...
			<form:input path="nameLike" htmlEscape="false" maxlength="50"
				class="input-medium form-control w200" />
		</div>
		...
		<tbody>
			<c:forEach items="${page.list}" var="genTable">
				<tr>
					...
					<shiro:hasPermission name="gen:genTable:edit">
						<td><a href="${ctx}/gen/genTable/form?id=${genTable.id}"
							title="修改">修改</a> <a
							href="${ctx}/gen/genTable/delete?id=${genTable.id}"
							onclick="return confirmx('确认要删除该业务表吗？', this.href)" title="删除">删除</a>
						</td>
					</shiro:hasPermission>
				</tr>
			</c:forEach>
