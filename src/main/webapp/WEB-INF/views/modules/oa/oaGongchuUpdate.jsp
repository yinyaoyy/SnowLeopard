...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/oa/oaGongchu/form?id=${oaGongchu.id}">修改公出单</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="oaGongchu" action="${ctx}/oa/oaGongchu/save" method="post" class="form-horizontal">
		...
		<div class="row">
		   <div class="col-xs-3">
			     <input id="btnSubmit" class="btn btn-primary" type="submit" value="重新申请" onclick="$('#flag').val('yes')"/>&nbsp;
