...
<div class="row">
	...
	<div class="col-xs-1">
		<div class="form-group">
			<label class="input-xlarge control-label">严重等级</label>
		</div>
	</div>
	<div class="col-xs-1">
		<div class="form-group">
...
<div id="peopleMediation_countYearCaseRank" style="width:100%;height:200px;"></div>
...
function getData(){
	...
	$.post("${ctx}/oa/act/oaPeopleMediationAcceptRegister/countByYearCaseRank",{"year":year},function(data){
		var dc = new Array();
		var an = new Array();
