...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="javascript;:">填写人民调解协议书</a></li>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="oaPeopleMediationAgreement"
		...
		<div class="row">
			...
			<div class="col-xs-3">
				<div class="form-group">
					<form:input path="agreementCode" htmlEscape="false" disabled="true"
		...
		<div class="row">
			...
			<div class="col-xs-11">
				<div class="form-group">
					<form:textarea path="disputeFact" disabled="true"
		...
		<div class="row">
			...
			<div class="col-xs-11">
				<div class="form-group">
					<form:textarea path="disputeMatter" disabled="true"
						htmlEscape="false" rows="8" class="form-control valid required" />
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-xs-11">
				<div class="form-group">
					<form:textarea path="agreementContent" disabled="true"
						htmlEscape="false" rows="8" class="form-control valid required" />
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-xs-11">
				<div class="form-group">
					<form:textarea path="performMode" disabled="true"
						htmlEscape="false" rows="8" class="form-control valid required" />
				</div>
			</div>
		</div>
