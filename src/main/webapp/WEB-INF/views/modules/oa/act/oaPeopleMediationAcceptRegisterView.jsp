...
<body>
	<ul class="nav nav-tabs">
		<c:choose>
			<c:when test="${zt!=3 }">
				...
				<li class="active"><a href="javascript:;">查看人民调解受理登记表</a></li>
			</c:when>
			<c:otherwise>
				<li class="active"><a href="javascript:;">查看人民调解受理登记表</a></li>
			</c:otherwise>
	...
	<form:form id="inputForm"
			...
			<div class="col-xs-3">
				<div class="form-group">
					<input name="oaPeopleMediationApply.accuserBirthday" type="text"
						disabled="true" maxlength="20" class="form-control required"
		...
		<div class="row">
			...
			<div class="col-xs-3">
				<div class="form-group">
					<input name="oaPeopleMediationApply.defendantBirthday" type="text"
			...
			<div class="col-xs-3">
				<div class="form-group">
					<sys:treeselect id="oaPeopleMediationApply.caseCounty"
						...
						title="区域" url="/sys/area/treeData"
						cssClass=" form-control  valid " allowClear="false"
						notAllowSelectParent="false" disabled="true" />
				</div>
			</div>
			<div class="col-xs-1">
				<div class="form-group">
