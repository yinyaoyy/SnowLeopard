...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a
			href="${ctx}/oa/act/oaPeopleMediationVisit/form?id=${oaPeopleMediationVisit.id}">人民调解回访记录</a></li>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="oaPeopleMediationVisit"
		...
		<div class="row">
			...
			<div class="col-xs-3">
				<div class="form-group">
					<form:input path="visitCause" htmlEscape="false" rows="8"
		...
		<div class="row">
			...
			<div class="col-xs-11">
				<div class="form-group">
					<form:textarea path="visitSituation" htmlEscape="false" rows="8"
						class="form-control valid required" />
				</div>
			</div>
		</div>
		...
		<div class="form-actions">
			<shiro:hasPermission name="oa:act:oaPeopleMediationVisit:edit">
