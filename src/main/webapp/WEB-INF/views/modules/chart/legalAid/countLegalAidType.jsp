...
<div class="row">
	<div class="col-xs-12 bg-info" style="padding:5px">
		<div class="form-group" style="margin-bottom: 0px;">
			...
			<span style="font-size:16px;font-weight:bold;">当事人申请与通知辩护法律援助案件数量对比</span>
		</div>
	</div>
...
var types = [{value:1,label:'当事人申请'},{value:2,label:'通知辩护'}];//申请方式集合
// ajax异步获取数据
/* function getData(){
	var year = $("#year").val();
	var areaId = $("#area").val();
	countLegalAidType.showLoading();
	$.post("${ctx}/chart/legalAid/countLegalAidType",{"year":year,"area.id":areaId},function(data){
		var ct = new Array();
		var ctD = new Array();
		var hasVal = false;
		var total = 0;
...
function getData1(){
	...
	countLegalAidType.showLoading();
	$.post("${ctx}/chart/legalAid/countLegalAidType",{"area.id":areaId,"beginDate":beginDate,"endDate":endDate},
		function(data){
		var ct = new Array();
		var ctD = new Array();
		var hasVal = false;
